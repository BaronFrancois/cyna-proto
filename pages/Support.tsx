...
export const Support: React.FC = () => {
  ...
  const handleSendMessage = async () => {
    ...
    setHistory([...newHistory, { role: 'model' as const, parts: [{ text: responseText }] }]);
    setIsLoading(false);
  };
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="bg-gray-50 py-20 text-center px-4">
        <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">Comment pouvons-nous vous aider ?</h1>
      ...
      <div className="max-w-4xl mx-auto px-4 py-20 grid grid-cols-1 md:grid-cols-2 gap-12">
         ...
         <div>
            ...
            <form className="space-y-4">
               <div>
                  ...
                  <input type="email" className="w-full p-3 rounded-lg bg-gray-50 border border-gray-200" />
               </div>
               <div>
               ...
               <div>
                  ...
                  <textarea rows={5} className="w-full p-3 rounded-lg bg-gray-50 border border-gray-200"></textarea>
               </div>
         ...
         <div className="flex flex-col justify-center items-center bg-blue-50 rounded-3xl p-10 text-center">
            ...
            <h2 className="text-2xl font-bold text-gray-900 mb-2">Assistant IA Cyna</h2>
            <p className="text-gray-500 mb-8">Obtenez des réponses instantanées sur nos produits et services grâce à notre IA avancée.</p>
            <Button onClick={() => setIsChatOpen(true)}>Démarrer le Chat</Button>
         </div>
      </div>
          ...
          <div className="bg-white w-full max-w-md h-[600px] rounded-3xl shadow-2xl flex flex-col overflow-hidden animate-in fade-in zoom-in duration-300">
             ...
             <div className="bg-gray-100 p-4 flex justify-between items-center border-b border-gray-200">
                <div className="flex items-center space-x-2">
                   ...
                   <span className="font-semibold text-gray-900">IA Cyna</span>
                </div>
                <button onClick={() => setIsChatOpen(false)} className="text-gray-500 hover:text-gray-900">
                   <X size={20} />
                </button>
             </div>
             ...
             <div className="flex-grow overflow-y-auto p-6 space-y-4 bg-white">
                {history.length === 0 && (
                   <div className="text-center text-gray-400 mt-10">
                      ...
                      <p>Posez-moi des questions sur Cyna EDR, XDR ou les tarifs.</p>
                   </div>
                )}
                {history.map((msg, i) => (
