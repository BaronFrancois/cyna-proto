...
export const Checkout: React.FC = () => {
  ...
  const StepIndicator = ({ num, title }: { num: number, title: string }) => (
    <div className={`flex items-center space-x-2 ${step >= num ? 'text-gray-900' : 'text-gray-400'}`}>
       <div className={`w-6 h-6 rounded-full flex items-center justify-center text-xs border ${
          step >= num ? 'bg-black text-white border-black' : 'bg-transparent border-gray-300'
       }`}>
    ...
    <div className="max-w-3xl mx-auto px-4 py-16">
       ...
       {step === 1 && (
         <div className="fade-in">
            <h2 className="text-3xl font-bold mb-8">Connectez-vous pour aller plus vite.</h2>
       ...
       {step === 2 && (
         <div className="fade-in">
            <h2 className="text-3xl font-bold mb-8">Où devons-nous envoyer la facture ?</h2>
       ...
       {step === 3 && (
         <div className="fade-in">
            <h2 className="text-3xl font-bold mb-8">Paiement Sécurisé.</h2>
            <div className="bg-gray-50 p-6 rounded-2xl border border-gray-200 max-w-lg mb-8">
